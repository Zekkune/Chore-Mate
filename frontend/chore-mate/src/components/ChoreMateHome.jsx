...
export default function ChoreMateHome () {
    ...
    <div className="h-screen grid grid-cols-6 grid-rows-8 gap-x-0 gap-y-0">
      <div className="bg-red-200 col-span-6 row-span-1 flex">Div 1
    
      </div>
      <div className="bg-blue-200 col-span-1 row-span-6 col-start-1 row-start-2 flex flex-col items-center">
      <Link to = '/api/create_person/' className="h-auto bg-blue-400 text-white py-2 px-4 rounded-md shadow hover:bg-blue-500 mt-6 w-10/12 text-xs">Add a new person</Link>
      {/* <Link to = '/api/update_person/' className="h-auto bg-blue-400 text-white py-2 px-4 rounded-md shadow hover:bg-blue-500 mt-6 w-10/12 text-xs">Update a person</Link> */}
      </div>
